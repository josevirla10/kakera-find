...
export function ProductCard({ product }: ProductCardProps) {
  return (
    <a
      ...
      className="group flex flex-col bg-surface-card rounded-2xl overflow-hidden shadow-card hover:shadow-card-hover border border-border-subtle hover:border-border-hover transition-all duration-200"
    >
      {/* Image */}
